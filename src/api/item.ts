...
// UI_ITM_002.vue
// 품목 상세 정보 조회
export function selectItem(params: ItemProps) {
    return api.get<ApiResponse<ItemProps[]>>(`${BASE}/itemDetail/selectItem`, { params });
}

// UI_ITM_002.vue
// 품목 상세 정보 저장
export function saveItemReg(params: any) {
...
// UI_ITM_003.vue
// 품목 목록 조회
export function selectItemLabelList(params: ItemProps) {
    return api.get<ApiResponse<ItemProps>>(`${BASE}/itemLabel/selectItemList`, { params });
}

// UI_ITM_003.vue
// 품목 속성 조회
export function selectLabelList(params: ItemLabelProps) {
    return api.get<ApiResponse<ItemLabelProps>>(`${BASE}/itemLabel/selectLabelList`, { params });
}

// UI_ITM_003.vue
// 속성 저장
export function saveLabel(params: ItemLabelProps) {
...
// ========================================================
// 팝업 품목 조회
export function selectPopupItem(params: ItemProps) {
...
// ========================================================
// 팝업 판매단가 품목 조회
export function selectPopupSaleItem(params: ItemPriceProps) {
...
// ========================================================
// 조회
export function selectPopupPurchItem(params: ItemPriceProps) {
